...
Which witches and other Excel tasks.....in R. 

Run each line of code yourself or Knit to HTML to walk through this tutorial.

The dataset used in this exercise is of 43,000 people tried for witchcraft across
...
structure(witchdat)
```
It looks like there are character variables and numeric variables.
...
# or we can use dplyr mutate_all to change types of all integer variables
witchdat <- witchdat %>% 
...
A neat package that creates interactive pivot tables is [rpivotTable]((https://cran.r-project.org/web/packages/rpivotTable/).   Have a look at this package's [vignette](https://cran.r-project.org/web/packages/rpivotTable/vignettes/rpivotTableIntroduction.html).
