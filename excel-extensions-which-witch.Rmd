...
**Tip:** Install the package from CRAN the first time you use the package using the function else you would get an Error that there is no package.
...
```{r format}
# Use dplyr to rename a variable. From inspection of witchdat this cryptic name gadm.adm0 refers to country.
witchdat <- witchdat %>% 
